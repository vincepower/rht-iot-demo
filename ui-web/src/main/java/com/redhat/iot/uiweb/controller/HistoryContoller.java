...
public class HistoryContoller {
    private final String APIBASE = "http://ec-api-iot-demo-371b.apps.rhpds310.openshift.opentlc.com";
    private final String USERNAME= "user1";
    private final String PASSWORD = "Infosys123!@#";
    ...
    public ChartData getSensorHistory(@PathVariable String sensor) {
       // List<Double> data = new ArrayList<>();
        ...
        HttpEntity<AuthToken> tokenResponse = authTemplate.postForEntity(AUTHURL, authRequest, AuthToken.class);
